...
async def income_flow(callback: types.CallbackQuery, state: FSMContext):
    ...
    if callback.data == "income_bonus":
        ...
        await callback.message.edit_text(
            ...
            "• ⏰ <b>Какой график?</b>\n"
            "Свободный режим: сами выбираете удобные слоты. Сами выбираете в какой день работать. Слот - это смена не несколько часов. Можно отработать один или несколько сразу.\n\n"
