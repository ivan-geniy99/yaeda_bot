...
async def age_answer(callback: types.CallbackQuery, state: FSMContext):
    if callback.data == "age_no":
        await callback.message.edit_text(
            ...
            "📩 Подать отклик и рассчитать доход можно здесь: <a href='https://reg.eda.yandex.ru/?advertisement_campaign=forms_for_agents&user_invite_code=4fd8c46d41724e86a4448b0367951ddb&utm_content=blank'>ссылка</a>.",
            parse_mode="HTML",
